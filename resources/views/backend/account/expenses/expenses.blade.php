...
<div class="pcoded-main-container">
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/daily-expenses">Daily Expenses</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- [ Main Content ] start -->
        <div class="card">
            <div class="card-header bg-warning">Daily Expenses</div>
            <div class="card-body">
                <form action="/daily-expenses-paid" method="GET" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <label for="doctor" class="form-label">Category</label>
                            <select id="category" name="cbxCategory" required class="custom-select" id="doctor">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="subcategory" name="cbxSubCategory" class="custom-select" id="refer">
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="450" name="txtAmount" placeholder="Enter expenses Amount" required>
                            </div>
                        </div>
                        <div class="col-md-12 mt-4">
                            <div class="form-group">
                                <label for="categoryName">Remark's</label>
                                <input type="text" class="form-control" name="txtRemarks" placeholder="Remark's" value="N/A" required>
                            </div>
                        </div>
                        <div class="col-md-12 mt-4">
                            <div class="form-group">
