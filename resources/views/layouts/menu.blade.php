		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Dignosis Test</span></a>
						<ul class="pcoded-submenu">
                            <li><a href="/test-sale-view">Test Sale</a></li>
							<li><a href="/deu-collection-view">Due Collection</a></li>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu profile-notification ">
									<ul class="pro-body">
										...
										<li><a href="/logout" class="dropdown-item"><i class="fas fa-circle"></i> Lock Screen</a></li>
									</ul>
								</div>
							</div>
						</li>
										...
										<li class="notification">
											<div class="media">
												...
												<div class="media-body">
													<p><strong>Xons David</strong><span class="n-time text-muted"><i class="icon feather icon-clock m-r-10"></i>5 min</span></p>
